...
export HBASE_OPTS="-XX:+UseG1GC -XX:+UseMembar"
...
#export SERVER_GC_OPTS="-verbose:gc -XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:/opt/hbase-data/logs/hbase-gc.log"
